...
namespace LaMulana2RandomizerShared
{
    ...
    public enum LocationID
    {
        ...
        MoGLadderCoinPot = 412,
        MoGBreakableWallCoinPot = 413,
        MoGFutoStatueCoinPot = 414,
        MoGPreRatatoskrWeightPot = 415,
        RoYSecondRoomWeightPot = 416,
        RoYWeaponVaultCoinPot = 417,
        RoYWeaponVaultWeightPot = 418,
        RoYConvenientShurikenPot = 419,
        RoYBelowRatatoskrCoinPot = 420,
        RoYFootprintShurikenPot = 421,
        RoYBridgeCoinPot = 422,
        RoYBirthSealGateShurikenPot = 423,
        RoYFirstRoomCoinPot = 424,
        RoYLargeBreakableWallCoinPot = 425,
        RoYKorobockWeightPot = 426,
        RoYLampofTimeWeightPot = 427,
        RoYTorchRoomShurikenPot = 428,
        RoYGoldenRockCoinPot = 429
    }
}
