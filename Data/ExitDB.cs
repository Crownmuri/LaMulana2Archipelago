...
namespace LM2RandomiserMod
{
    public abstract class ExitDB
    {
        ...
        private static readonly Dictionary<ExitID, ExitInfo> connectionData = new Dictionary<ExitID, ExitInfo>(){
            ...
            { ExitID.fEx1Down,        new ExitInfo("PlayerStart",                30, -1, -1)},
            { ExitID.fEx1_L0,         new ExitInfo("PlayerStart_L0",             30, -1, -1)},
            { ExitID.fEx1_L1,         new ExitInfo("PlayerStart_L1",             30, -1, -1)},
            { ExitID.fEx1_L2,         new ExitInfo("PlayerStart_L2",             30, -1, -1)},
            { ExitID.fEx1_L3,         new ExitInfo("PlayerStart_L3",             30, -1, -1)},
            { ExitID.fEx1_L4,         new ExitInfo("PlayerStart_L4",             30, -1, -1)},
            ...
            { ExitID.fEx2_L3,         new ExitInfo("PlayerStart_L3",             31, -1, -1)},
            { ExitID.fEx2_L4,         new ExitInfo("PlayerStart_L4",             31, -1, -1)},
